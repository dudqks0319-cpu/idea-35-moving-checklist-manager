...
import 'package:app_35_moving_checklist_manager/app.dart';
import 'package:app_35_moving_checklist_manager/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('이사 체크리스트 매니저'), findsWidgets);
